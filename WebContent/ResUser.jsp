...
<html:html lang="true">
  ...
  <% 
	com.chinaedustar.common.PageVerifyOpe.DoForgetPsd(pageContext);
 %> 
  <body onload="document.getElementById('answer').focus()" style="margin:0">
  <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	    <td><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
	      <tr>
	        <td>&nbsp;</td>
	        <td style="font-size:12pt"><b style="color:red">第二步：</b><b style="color:blue">输入恢复口令答案</b></td>
	        <td>&nbsp;</td>
	      </tr>
	      <tr>
	      ...
	      <tr>
	        ...
	        <td>
	        <html:form action="forgetUserPsd.do" method="post">
	        <table width="60%" height="180px" border="0" align="center" cellpadding="0" cellspacing="0">
	          <tr>
	            <td>&nbsp;</td>
	            </tr>
	          <tr>
		          <td style="font-size:9pt">用 户 名：<bean:write name="CurDataInfo" property="loginId" scope="page" /></td>
		        </tr>
		        <tr>
		          <td style="font-size:9pt">密码问题：<bean:write name="CurDataInfo" property="question" scope="page" /></td>
		        </tr>
		        <tr>
		          <td style="font-size:9pt">密码答案：<html:password property="answer" style="width:200;height:20;" /></td>
		        </tr>
		        <tr>
		          <td><input type="hidden" name="userId" value="<bean:write name="CurDataInfo" property="loginId" scope="page" />"></td>
		      </tr>
	          <tr>
	            <td><div align="center">
